...
class MyCustomButtomNavigation extends StatelessWidget {
  ...
  const MyCustomButtomNavigation({Key key,@required this.currentTab,@required this.onSelectedTab,@required this.createPage,@required this.navigatorKeys}) : super(key: key);
